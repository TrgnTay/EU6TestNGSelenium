...
public class iframeTest {
    ...
    public void test1() throws InterruptedException {
        ...
        driver.findElement(By.cssSelector("#tinymce")).clear();
        Thread.sleep(1000);
        driver.findElement(By.id("tinymce")).sendKeys("mikesmith with index");
...
driver.switchTo().frame(iframeElement);
        ...
        Thread.sleep(1000);
        driver.findElement(By.id("tinymce")).sendKeys("mikesmith with Webelement");
    }
...
@Test
    ...
    //we can not switch between the siblings, we can not switch middile to right or to left directly
